...
// ---------------------------------------------------------------------------
function $8970fb668f57fa15$var$LogEntry({ log: log, agentEndpoint: agentEndpoint, authToken: authToken }) {
    const [isExpanded, setIsExpanded] = (0, $5OpyM$useState)(false);
    const [isDownloading, setIsDownloading] = (0, $5OpyM$useState)(false);
...
/* ── Helpers ─────────────────────────────────────────────────────────────── */ const $f07f82aa3d2327c0$export$60423fe9397f59f0 = 20;
function $f07f82aa3d2327c0$export$7a5253c0f62e0150(raw) {
    try {
...
function $f07f82aa3d2327c0$export$70bebcf06f7d915e(raw) {
    const s = raw.trim();
...
function $f07f82aa3d2327c0$export$a0853eed8a0086e8(raw) {
...
function $5ae69312acd093ed$export$22e84aab505142f2({ agentRegistryUrl: agentRegistryUrl, authToken: authToken }) {
    ...
    const [deploymentMode, setDeploymentMode] = (0, $5OpyM$useState)('docker');
    ...
    const parsedUrl = (0, $f07f82aa3d2327c0$export$7a5253c0f62e0150)(sourceUrl);
    const gitUrlValid = (0, $f07f82aa3d2327c0$export$70bebcf06f7d915e)(sourceUrl);
    const descWordCount = description.trim().split(/\s+/).filter(Boolean).length;
    const descValid = description.trim().length >= (0, $f07f82aa3d2327c0$export$60423fe9397f59f0);
    const handleNameChange = (e)=>{
        setName((0, $f07f82aa3d2327c0$export$a0853eed8a0086e8)(e.target.value));
        setNameTouched(true);
    };
    ...
    const validate = ()=>{
        ...
        if (!descValid) return `Description must be at least ${0, $f07f82aa3d2327c0$export$60423fe9397f59f0} characters.`;
                                    ...
                                    /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                ...
                                                children: [
                                                    "Min ",
                                                    (0, $f07f82aa3d2327c0$export$60423fe9397f59f0),
                                                    " characters"
                                                ]
                                            })
                                        ]
...
function $8198219ff0031b60$var$agentInitials(name = '') {
...
const $8198219ff0031b60$var$LC_AVATAR_PALETTES = [
    'lc-av-blue',
    'lc-av-teal',
    'lc-av-amber',
    'lc-av-coral',
...
function $8198219ff0031b60$var$agentAvatarClass(name = '') {
    const hash = [
        ...name
    ].reduce((acc, ch)=>acc + ch.charCodeAt(0), 0);
    return $8198219ff0031b60$var$LC_AVATAR_PALETTES[hash % $8198219ff0031b60$var$LC_AVATAR_PALETTES.length];
}
/* ── Version Manager (sub-component of AgentLifeCycleTab) ────────────────── */ function $8198219ff0031b60$var$getUpdateLabel(selected, current) {
...
function $8198219ff0031b60$var$VersionManager({ agent: agent, selectedVer: selectedVer, isActing: isActing, onSelectVersion: onSelectVersion, onApply: onApply }) {
    const [customVer, setCustomVer] = (0, $5OpyM$useState)('');
    const [useCustom, setUseCustom] = (0, $5OpyM$useState)(false);
    ...
    const btnLabel = $8198219ff0031b60$var$getUpdateLabel(targetVer, currentVer);
        ...
        children: [
            /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                ...
                children: [
                    ...
                    currentVer ? /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
            ...
            /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                ...
                children: [
                    useCustom ? /*#__PURE__*/ (0, $5OpyM$jsx)("input", {
                        ...
                        disabled: isActing,
                        autoFocus: true
                    }) : otherVers.length > 0 ? /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                        ...
                        children: /*#__PURE__*/ (0, $5OpyM$jsxs)("select", {
                            ...
                            children: [
                                ...
                                otherVers.map((v)=>/*#__PURE__*/ (0, $5OpyM$jsx)("option", {
                                        value: v,
                                        children: v
                                    }, v))
                            ]
            ...
            availableVers.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                className: "lc-version-pills",
                children: availableVers.map((v)=>/*#__PURE__*/ (0, $5OpyM$jsxs)("span", {
                        ...
                        children: [
                            v,
                            v === currentVer && /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
...
function $8198219ff0031b60$export$ddee814a694c1fcc({ agentRegistryUrl: agentRegistryUrl, authToken: authToken }) {
    const [agents, setAgents] = (0, $5OpyM$useState)([]);
    const [isFetching, setIsFetching] = (0, $5OpyM$useState)(false); // true only while GET /info is in-flight
    const [isActing, setIsActing] = (0, $5OpyM$useState)(false); // true while a lifecycle action is running
    const [error, setError] = (0, $5OpyM$useState)('');
    const [success, setSuccess] = (0, $5OpyM$useState)('');
    const [page, setPage] = (0, $5OpyM$useState)(1);
    // Per-agent stream state: { [agentName]: { output, isStreaming, isOpen, action } }
    const [agentStreams, setAgentStreams] = (0, $5OpyM$useState)({});
    const outputRefs = (0, $5OpyM$useRef)({});
    // Per-agent selected version for upgrade/downgrade: { [agentName]: versionString }
    const [selectedVersions, setSelectedVersions] = (0, $5OpyM$useState)({});
    (0, $5OpyM$useEffect)(()=>{
        fetchAgents();
    }, []);
    ...
    // Search + filter state
    const [search, setSearch] = (0, $5OpyM$useState)('');
    const [statusFilter, setStatusFilter] = (0, $5OpyM$useState)('all'); // 'all' | 'active' | 'stopped'
    const [expandedAgent, setExpandedAgent] = (0, $5OpyM$useState)(null); // name of expanded row
    const [sortField, setSortField] = (0, $5OpyM$useState)('name'); // 'name' | 'status' | 'framework'
    const [sortDir, setSortDir] = (0, $5OpyM$useState)('asc');
    ...
    const SortIcon = ({ field: field })=>{
        if (sortField !== field) return /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
    ...
    return /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
        children: [
            !isFetching && agents.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                ...
                children: [
                    ...
                    otherCount > 0 && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                        className: "lc-stat-card",
                        children: [
                            /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                                className: "lc-stat-label",
            ...
            /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                                ...
                                children: filterTabs.map((tab)=>/*#__PURE__*/ (0, $5OpyM$jsxs)("button", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            search && /*#__PURE__*/ (0, $5OpyM$jsx)("button", {
                                    ...
                                    /*#__PURE__*/ (0, $5OpyM$jsx)("button", {
                                        ...
                                        onClick: fetchAgents,
                                        disabled: isFetching,
                                        children: isFetching ? /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
                                            children: [
                                                /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                                                    className: "cfg-spinner"
                                                }),
                    ...
                    (error || success) && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                    ...
                    /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                        ...
                        children: [
                            isFetching && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                            ...
                            !isFetching && filteredAgents.length === 0 && /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                                className: "lc-table-empty",
                                children: search || statusFilter !== 'all' ? /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
                                    children: [
                            ...
                            pageAgents.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsxs)("table", {
                                className: "lc-table",
                                children: [
                                    /*#__PURE__*/ (0, $5OpyM$jsx)("thead", {
                                        children: /*#__PURE__*/ (0, $5OpyM$jsxs)("tr", {
                                            children: [
                                                /*#__PURE__*/ (0, $5OpyM$jsx)("th", {
                                                    className: "lc-th lc-th-expand"
                                                }),
                                                /*#__PURE__*/ (0, $5OpyM$jsxs)("th", {
                                                    className: "lc-th lc-th-agent",
                                                    onClick: ()=>handleSort('name'),
                                                    children: [
                                                        "Agent ",
                                                        /*#__PURE__*/ (0, $5OpyM$jsx)(SortIcon, {
                                                            field: "name"
                                                        })
                                                    ]
                                                }),
                                    ...
                                    /*#__PURE__*/ (0, $5OpyM$jsx)("tbody", {
                                        children: pageAgents.map((agent, index)=>{
                                            const status = (agent.status || 'unknown').toLowerCase();
                                            const initials = $8198219ff0031b60$var$agentInitials(agent.name);
                                            const avatarCls = $8198219ff0031b60$var$agentAvatarClass(agent.name || '');
                                            ...
                                            return /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$react).Fragment, {
                                                children: [
                                                    /*#__PURE__*/ (0, $5OpyM$jsxs)("tr", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, $5OpyM$jsx)("td", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        isStreaming && /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                            ...
                                                            /*#__PURE__*/ (0, $5OpyM$jsx)("td", {
                                                                ...
                                                                children: agent.framework ? /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                            ...
                                                            /*#__PURE__*/ (0, $5OpyM$jsx)("td", {
                                                                ...
                                                                onClick: (e)=>e.stopPropagation(),
                                                                children: agent.tags && agent.tags.length > 0 ? /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                    className: "lc-agent-tags lc-agent-tags--row",
                                                                    children: [
                                                                        agent.tags.slice(0, 3).map((tag)=>/*#__PURE__*/ (0, $5OpyM$jsxs)("span", {
                                                                                className: "lc-tag",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                                        ...
                                                                        agent.tags.length > 3 && /*#__PURE__*/ (0, $5OpyM$jsxs)("span", {
                                                            ...
                                                            /*#__PURE__*/ (0, $5OpyM$jsx)("td", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        (hasLog || isStreaming) && /*#__PURE__*/ (0, $5OpyM$jsx)("button", {
                                                    ...
                                                    isExpanded && /*#__PURE__*/ (0, $5OpyM$jsx)("tr", {
                                                        className: "lc-tr-detail",
                                                        children: /*#__PURE__*/ (0, $5OpyM$jsx)("td", {
                                                            colSpan: 6,
                                                            ...
                                                            children: /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                        ...
                                                                        children: [
                                                                            agent.endpoint && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                            ...
                                                                            agent.port && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                                className: "lc-detail-meta-item",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                                                        className: "lc-detail-meta-key",
                                                                            ...
                                                                            agent.framework && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                                className: "lc-detail-meta-item",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                                                        className: "lc-detail-meta-key",
                                                                            ...
                                                                            agent.source && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                                className: "lc-detail-meta-item",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                                                        className: "lc-detail-meta-key",
                                                                    ...
                                                                    agent.tags && agent.tags.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                                                                        className: "lc-detail-tags",
                                                                        children: agent.tags.map((tag)=>/*#__PURE__*/ (0, $5OpyM$jsxs)("span", {
                                                                                className: "lc-tag",
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                                                        className: "lc-tag-hash",
                                                                    ...
                                                                    /*#__PURE__*/ (0, $5OpyM$jsx)($8198219ff0031b60$var$VersionManager, {
                                                                        agent: agent,
                                                                    ...
                                                                    (hasLog || isStreaming) && isLogOpen && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                            ...
                                                                            /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                                ...
                                                                                children: [
                                                                                    /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                                                        ...
                                                                                        children: isStreaming ? /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
                                                                                            children: [
                                                                                                /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                                                                    ...
                                                                                    !isStreaming && /*#__PURE__*/ (0, $5OpyM$jsx)("button", {
                                                                    ...
                                                                    /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            (hasLog || isStreaming) && /*#__PURE__*/ (0, $5OpyM$jsxs)("button", {
                    ...
                    !isFetching && filteredAgents.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
...
function $379ef37eb3f3ccfb$export$cd8ed73ab24942a3() {
    ...
    return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                className: "cfg-body",
                children: [
                    activeTab === 'register' && /*#__PURE__*/ (0, $5OpyM$jsx)((0, $5ae69312acd093ed$export$22e84aab505142f2), {
                        agentRegistryUrl: agentRegistryUrl,
                        authToken: authToken
                    }),
                    activeTab === 'lifecycle' && /*#__PURE__*/ (0, $5OpyM$jsx)((0, $8198219ff0031b60$export$ddee814a694c1fcc), {
                        agentRegistryUrl: agentRegistryUrl,
                        authToken: authToken
                    }),
                    activeTab === 'token' && /*#__PURE__*/ (0, $5OpyM$jsx)((0, $379ef37eb3f3ccfb$export$cd8ed73ab24942a3), {})
                ]
            })
        ]
    });
...
/* ── Helpers ─────────────────────────────────────────────────────────────── */ function $b3abbbc0304bc4a9$var$StatusBadge({ initialized: initialized }) {
...
function $b3abbbc0304bc4a9$var$BoolBadge({ value: value }) {
...
function $b3abbbc0304bc4a9$var$FrameworkBadge({ value: value }) {
    return /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
        className: "ai-fw-badge",
        children: value
    });
}
function $b3abbbc0304bc4a9$var$MetaRow({ label: label, children: children }) {
    return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
...
function $b3abbbc0304bc4a9$var$TagPill({ children: children }) {
    return /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
        className: "ai-pill",
        children: children
    });
}
function $b3abbbc0304bc4a9$var$PromptCard({ text: text, index: index }) {
    const [expanded, setExpanded] = (0, $5OpyM$useState)(false);
    ...
    return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
        ...
        children: [
            ...
            isLong && /*#__PURE__*/ (0, $5OpyM$jsx)("button", {
...
function $b3abbbc0304bc4a9$var$SectionCard({ title: title, accent: accent, children: children }) {
    return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
        className: `ai-section-card ${accent ? `ai-section-card--${accent}` : ''}`,
        children: [
            title && /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
...
function $b3abbbc0304bc4a9$var$Stat({ label: label, value: value, mono: mono }) {
    return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
        className: "ai-stat",
        children: [
            /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
...
function $b3abbbc0304bc4a9$export$8be561ade2b12cd5({ agentName: agentName, agentEndpoint: agentEndpoint, authToken: authToken, onBack: onBack }) {
    const [agentInfo, setAgentInfo] = (0, $5OpyM$useState)(null);
    const [isLoading, setIsLoading] = (0, $5OpyM$useState)(true);
    const [error, setError] = (0, $5OpyM$useState)('');
    (0, $5OpyM$useEffect)(()=>{
    ...
    /* ── Loading ── */ if (isLoading) return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
    ...
    /* ── Error ── */ if (error) return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
    ...
    if (!agentInfo) return /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
        className: "cfg-list-empty",
        ...
        children: /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
            ...
            children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                            ...
                            children: [
                                ...
                                description && /*#__PURE__*/ (0, $5OpyM$jsx)("p", {
                                ...
                                /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$StatusBadge, {
                                            initialized: initialized
                                        }),
                                        framework && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$FrameworkBadge, {
                                            value: framework
                                        }),
                                        cloud_provider && /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                ...
                /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$Stat, {
                            label: "Auth",
                        ...
                        subAgents.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
                            children: [
                                /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                                    className: "ai-stats-divider"
                                }),
                ...
                /*#__PURE__*/ (0, $5OpyM$jsxs)($b3abbbc0304bc4a9$var$SectionCard, {
                    title: "Runtime",
                    children: [
                        /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$MetaRow, {
                            label: "Endpoint",
                            children: /*#__PURE__*/ (0, $5OpyM$jsx)("code", {
                        ...
                        /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$MetaRow, {
                            ...
                            children: /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$BoolBadge, {
                                value: auth_enabled
                            })
                        }),
                        /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$MetaRow, {
                        ...
                        cloud_provider && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$MetaRow, {
                ...
                agent_config && /*#__PURE__*/ (0, $5OpyM$jsxs)($b3abbbc0304bc4a9$var$SectionCard, {
                    title: "Configuration",
                    children: [
                        agent_config.type && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$MetaRow, {
                            label: "Type",
                            children: /*#__PURE__*/ (0, $5OpyM$jsx)("span", {
                                className: "ai-plain-val",
                        ...
                        agent_config.source && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$MetaRow, {
                            label: "Source",
                            children: /*#__PURE__*/ (0, $5OpyM$jsx)("code", {
                                className: "ai-mono-val",
                        ...
                        agent_config.model && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$MetaRow, {
                            label: "Model",
                            children: /*#__PURE__*/ (0, $5OpyM$jsxs)("span", {
                                ...
                                children: [
                                    ...
                                    agent_config.model.temperature != null && /*#__PURE__*/ (0, $5OpyM$jsxs)("span", {
                ...
                subAgents.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$SectionCard, {
                    title: "Sub-Agents",
                    children: /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                        className: "ai-subagent-grid",
                        children: subAgents.map((sa)=>/*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                ...
                tags.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$SectionCard, {
                    title: "Tags",
                    children: /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                        className: "ai-pill-row",
                        children: tags.map((t, i)=>/*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$TagPill, {
                                children: t
                            }, i))
                    })
                }),
                prompts.length > 0 && /*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$SectionCard, {
                    title: "Example Prompts",
                    children: /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                        className: "ai-prompt-list",
                        children: prompts.map((p, i)=>/*#__PURE__*/ (0, $5OpyM$jsx)($b3abbbc0304bc4a9$var$PromptCard, {
                                text: p,
                                index: i
                            }, i))
                    })
...
function $91ca74acd8eeb46c$export$8295a33ab8a36876(props) {
    ...
    const [currentView, setCurrentView] = (0, $5OpyM$useState)('info');
            ...
            /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                ...
                children: selectedAgent ? /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
                    children: [
                        ...
                        currentView === 'info' && /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                            className: "sl-info-view",
                            children: /*#__PURE__*/ (0, $5OpyM$jsx)((0, $b3abbbc0304bc4a9$export$8be561ade2b12cd5), {
                                agentName: selectedAgent.name,
                                agentEndpoint: selectedAgent.endpoint,
                                authToken: authToken,
                                onBack: ()=>{}
            ...
            !isCollapsed && /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
                children: [
                    ...
                    /*#__PURE__*/ (0, $5OpyM$jsx)("ul", {
                        ...
                        children: paged.length === 0 ? /*#__PURE__*/ (0, $5OpyM$jsx)("li", {
                    ...
                    totalPages > 1 && /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
                        ...
                        children: [
                            ...
                            Array.from({
                                length: totalPages
                            }, (_, i)=>i + 1).map((p)=>/*#__PURE__*/ (0, $5OpyM$jsx)("button", {
...
function $38b317e169159a61$var$CardGridLauncher({ agents: agents, searchQuery: searchQuery, setSearchQuery: setSearchQuery, onOpen: onOpen }) {
    ...
    // Reset to page 1 when search changes
    const prevLen = (0, $5OpyM$react).useRef(filtered.length);
    ...
    return /*#__PURE__*/ (0, $5OpyM$jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                ...
                children: paged.length === 0 ? /*#__PURE__*/ (0, $5OpyM$jsx)("div", {
                    className: "tcl-launcher-empty",
                    children: "No agents match your search."
                }) : paged.map((agent, i)=>/*#__PURE__*/ (0, $5OpyM$jsx)($38b317e169159a61$var$AgentCard, {
                        agent: agent,
                        index: i,
                        onOpen: onOpen
                    }, agent.id))
